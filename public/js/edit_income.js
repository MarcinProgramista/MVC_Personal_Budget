document.addEventListener("DOMContentLoaded", function () {
  const editButtons = document.querySelectorAll(
    ".open-edit-income-details-balance-modal"
  );
  ...
  document
    ...
    .addEventListener("submit", async (e) => {
      ...
      const formData = {
        ...
        name: document.getElementById("editIncomeCategory").selectedOptions[0]
          .text,
        dateFirst: dateFirst,
      ...
      try {
        ...
        if (data.status === "success") {
          ...
          if (sumDiv) {
            sumDiv.textContent =
              parseFloat(data.received.sumAllIncomes) + " PLN";
          }

          const sumDivDetails = document.getElementById("sumIncomesDetails");
          if (sumDivDetails) {
            sumDivDetails.textContent =
              parseFloat(data.received.sumAllIncomes) + " PLN";
          }
